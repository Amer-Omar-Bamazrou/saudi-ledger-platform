...
- **🔴 AN OFFICIAL TRANSLATION IS A SECONDARY SOURCE — where the publisher says the original prevails, it says so because they DIFFER** (2026-09-02). ZATCA's own English of VAT-IR Art. 53 says the *details* must appear in Arabic "as a translation"; the Arabic says the **invoice** must BE in Arabic, with no such qualifier. Two rulings were derived from the weaker text. **Read the prevailing-language original for any clause a feature rests on.** Incident: findings file.
